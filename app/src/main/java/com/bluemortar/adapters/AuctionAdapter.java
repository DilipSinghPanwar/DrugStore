...
import com.bluemortar.activities.CartDetailsActivity;
...
public class AuctionAdapter extends RecyclerView.Adapter<AuctionAdapter.RecyclerViewViewHolder> {

    private Context mContext;
    private List<Auction> auctionList;

    public AuctionAdapter(Context mContext, List<Auction> auctionList) {
    ...
    public class RecyclerViewViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            Intent _intent = new Intent(v.getContext(), CartDetailsActivity.class);
