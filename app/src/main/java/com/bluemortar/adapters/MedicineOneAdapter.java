...
public class MedicineOneAdapter extends RecyclerView.Adapter<MedicineOneAdapter.RecyclerViewViewHolder> {

    Context mContext;
    List<Medicine> medicineList;

    public MedicineOneAdapter(Context mContext, List<Medicine> medicineList) {
    ...
    public RecyclerViewViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_topbrands, parent, false);
